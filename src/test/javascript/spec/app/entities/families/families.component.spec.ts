...
import { FamiliesComponent } from 'app/entities/families/families.component';
...
describe('Component Tests', () => {
  describe('Families Management Component', () => {
    let comp: FamiliesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FamiliesComponent, '')
        .compileComponents();
