...
import { CrossReferenceComponent } from 'app/entities/cross-reference/cross-reference.component';
...
describe('Component Tests', () => {
  describe('CrossReference Management Component', () => {
    let comp: CrossReferenceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CrossReferenceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.crossReferences[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
