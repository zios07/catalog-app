...
import { MotorsComponent } from 'app/entities/motors/motors.component';
import { MotorsService } from 'app/entities/motors/motors.service';
import { Motors } from 'app/shared/model/motors.model';

describe('Component Tests', () => {
  describe('Motors Management Component', () => {
    let comp: MotorsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MotorsComponent, '')
        .compileComponents();
