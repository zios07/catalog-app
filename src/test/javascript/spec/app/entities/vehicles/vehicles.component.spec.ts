...
import { VehiclesComponent } from 'app/entities/vehicles/vehicles.component';
...
describe('Component Tests', () => {
  describe('Vehicles Management Component', () => {
    let comp: VehiclesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VehiclesComponent, '')
        .compileComponents();
