...
import { VehicleBrandsComponent } from 'app/entities/vehicle-brands/vehicle-brands.component';
...
describe('Component Tests', () => {
  describe('VehicleBrands Management Component', () => {
    let comp: VehicleBrandsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VehicleBrandsComponent, '')
        .compileComponents();
