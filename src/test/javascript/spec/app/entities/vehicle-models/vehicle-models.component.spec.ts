...
import { VehicleModelsComponent } from 'app/entities/vehicle-models/vehicle-models.component';
...
describe('Component Tests', () => {
  describe('VehicleModels Management Component', () => {
    let comp: VehicleModelsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VehicleModelsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.vehicleModels[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
