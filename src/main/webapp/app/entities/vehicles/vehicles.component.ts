...
export class VehiclesComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.vehiclesService
      ...
      .subscribe(
        (res: HttpResponse<IVehicles[]>) => this.paginateVehicles(res.body, res.headers),
  ...
  trackId(index: number, item: IVehicles) {
    return item.id;
  }
  ...
  protected paginateVehicles(data: IVehicles[], headers: HttpHeaders) {
